...
class DataLayerParagraph extends Component {
	constructor() {
		super( ...arguments );
	...
	render() {
		...
		return (
			<Fragment>
				...
				<RichText
					tagName="p"
					className={ classnames( 'mtm-dl-paragraph', className, {
...
export default DLParagraphEdit;