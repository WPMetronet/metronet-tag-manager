...
var JS_TINY_MCE_SOURCE_DIR = path.resolve(__dirname, 'src/tinymce');
var JS_TINY_MCE_SOURCE_DIR = path.resolve(__dirname, 'dist/tinymce');
var CSS_TINY_MCE_SOURCE_DIR = path.resolve(__dirname, 'src/tinymce/css');
var CSS_TINY_MCE_SOURCE_DIR = path.resolve(__dirname, 'dist/tinymce/css');
...
gulp.task('copy_for_zip', function () {
	return gulp.src('dist/**')
		.pipe(plumber(reportError))
		.pipe(gulp.dest('metronet-tag-manager'));
});

gulp.task('build_zip', function () {
	return gulp.src('metronet-tag-manager/**/*', { base: "." })
		.pipe(plumber(reportError))
		.pipe(zip('metronet-tag-manager.zip'))
		.pipe(gulp.dest('.'));
});
